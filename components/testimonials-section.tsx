        ...
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
            ...
            <span className="relative inline-block">
              everyone's lips
              <div
                className={`absolute bottom-0 left-0 w-full h-3 bg-slate-400 transform -skew-x-12 transition-all duration-1000 ease-out -z-10 ${
        ...
        <div className="max-w-4xl mx-auto">
          <div className="relative bg-white rounded-2xl p-8 md:p-12 shadow-lg">
            ...
            <button
              ...
              className="absolute left-4 top-1/2 transform -translate-y-1/2 p-2 rounded-full bg-slate-400 hover:bg-slate-500 transition-colors"
            >
            ...
            <button
              ...
              className="absolute right-4 top-1/2 transform -translate-y-1/2 p-2 rounded-full bg-slate-400 hover:bg-slate-500 transition-colors"
            >
            ...
            {testimonials.map((_, index) => (
              <button
                ...
                className={`w-3 h-3 rounded-full transition-colors ${
                  index === currentIndex ? "bg-slate-400" : "bg-gray-300"
                }`}
              />
            ))}
          </div>
